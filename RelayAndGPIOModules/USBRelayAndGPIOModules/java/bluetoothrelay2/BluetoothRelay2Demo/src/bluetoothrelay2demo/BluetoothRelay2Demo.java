...
This demo code demonstrates how to turn a Bluetooth Relay Module's relay & IOs to on/off (logic high/low) state and 
...
public class BluetoothRelay2Demo {
    ...
    if(args.length > 0){
            ...
            try {               
                ...
                /* Bluetooth Relay 2 Module Firmware version - device ID get & set                   */
                /************************************************************************** 
                    Send a command to output a logic high at any IOs. The command that is 
                    used to accomplish this action is "ver/id get/id set/gpio set-clear-read". It is important to send 
                ...
                * ***************************************************************************/
                ...
                /* Relay 0/1 - on - off - read - reset  */
                port.writeString("\r");                
                port.writeString("relay on 7\r");
                ...
                port.writeString("\r");              
                port.writeString("relay writeall 00\r");
