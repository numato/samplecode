...
This demo code demonstrates how to turn a USB Powered Relay Module's relay & IOs to on/off (logic high/low) state and 
...
public class UsbPoweredRelay4Demo {
    ...
    public static void main(String[] args) {
        ...
        if(args.length > 0){
            ...
            try {               
                ...
                /* USB Powered Relay 4 Module firmware "version" - device ID get & set                  */
                /************************************************************************** 
                    Send a command to output a logic high at IOs. The command that is 
                    used to accomplish this action is "ver, id get, id set, gpio set/clear/read 0-3". It is important to send 
                ...
                * ***************************************************************************/
                ...
                /* Relay 0/1/2/3 - on - off - read - reset  */
                port.writeString("\r");                
                ...
                port.writeString("\r");              
                port.writeString("relay read 0\r");
                ...
                port.writeString("\r");               
                port.writeString("relay writeall 03\r");
                System.out.println("Info: <relay writeall XX> Command sent...");
                Thread.sleep(100);
                /* Flush the Serial port's RX & TX buffer*/
                port.purgePort(SerialPort.PURGE_RXCLEAR & SerialPort.PURGE_TXCLEAR);
