...
public class BluetoothRelay8Demo {
    ...
    if(args.length > 0){
            ...
            try {               
                ...
                /* Bluetooth Relay 8 Module firmware "version" - device ID get & set                       */
                /************************************************************************** 
                    Send a command to output a logic high at GPIO 0. The command that is 
                    used to accomplish this action is "ver / id get - set / gpio set-clear-read 0". It is important to send 
                ...
                * ***************************************************************************/
                ...
                port.writeString("\r");              
                port.writeString("relay writeall ff\r");
