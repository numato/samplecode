    ...
    public static void main(String[] args) {
        ...
        if(args.length > 0){
            ...
            try {               
                ...
                /* GPIO32 Module Firmware version - device ID get & set                 */
                /************************************************************************** 
                    Send a command to output a logic high/low/read status at GPIO 0 to V. The command that is 
                    used to accomplish this action is "gpio set/clear/read 0-V". It is important to send 
                ...
                */
                ...
                /* GPIO32 group Commands                   */
                /*********************************************************************************************************** 
                    Send a command to output a logic iodir - iomask - writeall - readall at GPIO 0 to V. The command that is 
                ...
                */                   
                ...
                /* GPIO32 IOdir - IOmask - Writeall - Readall */
                port.writeString("\r");               
                port.writeString("gpio iodir 00000000\r");
                System.out.println("Info: <gpio iodir XXXXXXXX> Command sent...");
                Thread.sleep(100);
                /* Flush the Serial port's RX & TX buffer. */
                port.purgePort(SerialPort.PURGE_RXCLEAR & SerialPort.PURGE_TXCLEAR);
                                
                port.writeString("\r");                
                port.writeString("gpio imask ffffffff\r");
                System.out.println("Info: <gpio iomask XXXXXXXX> Command sent...");
                Thread.sleep(100);
                /* Flush the Serial port's RX & TX buffer. */
                port.purgePort(SerialPort.PURGE_RXCLEAR & SerialPort.PURGE_TXCLEAR);
                
                 port.writeString("\r");                
                port.writeString("gpio writeall ffffffff\r");
                System.out.println("Info: <gpio writeall XXXXXXXX> Command sent...");
                Thread.sleep(100);
                /* Flush the Serial port's RX & TX buffer. */
                port.purgePort(SerialPort.PURGE_RXCLEAR & SerialPort.PURGE_TXCLEAR);
