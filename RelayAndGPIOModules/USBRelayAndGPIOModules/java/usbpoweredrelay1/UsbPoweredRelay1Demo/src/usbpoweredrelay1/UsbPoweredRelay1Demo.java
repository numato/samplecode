...
This demo code demonstrates how to turn a Powered Relay Module's relay & IOs to on/off (logic high/low) state and 
...
public class UsbPoweredRelay1Demo {
    ...
    public static void main(String[] args) {
        ...
        if(args.length > 0){
            ...
            try {               
                ...
                /* USB Powered Relay Module firmware "version" - device ID get & set  */
                /************************************************************************** 
                    Send a command to output a logic high at the IOs. The command that is 
                    used to accomplish this action is "gpio set/clear/read 0-3". It is important to send 
...
//                /* Write the command to port. Notice the Carriage Return (\r) at the end of the command */
                ...
                * ***************************************************************************/
                ...
                /* Relay 0 - on - off - read - reset  */
                port.writeString("\r");                
                port.writeString("relay on 0\r");
