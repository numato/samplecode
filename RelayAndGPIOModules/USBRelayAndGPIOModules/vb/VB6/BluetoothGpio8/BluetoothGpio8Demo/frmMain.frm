...
Private Sub cmdSetStatus_Click()
    ...
    'only when the GPIO module detects Carriage Return character.Please
    ...
    If MSComm1.PortOpen = True Then
        If Val(txtGpioStatus1) = 0 Then
            MSComm1.Output = "gpio clear" + Str(Val(txtGpioNumber1)) + Chr(13)
        Else
            MSComm1.Output = "gpio set" + Str(Val(txtGpioNumber1)) + Chr(13)
        End If
    Else
       ...
       Dim readData As String
        ...
        If MSComm1.PortOpen = True Then
            ...
            If Val(txtAnalogChannel.Text) < 6 Then
                ...
                'Commands to Bluetooth devices take longer to complete
                Sleep (200)
...
Private Sub cmdGetStatus_Click()
    ...
    If MSComm1.PortOpen = True Then
        ...
        If Val(txtGpioNumber2.Text) < 8 Then
                MSComm1.Output = ("gpio read" + Str(Val(txtGpioNumber2.Text)) + Chr(13))
                'Commands to Bluetooth devices take longer to complete
                Sleep (200)
                readData = MSComm1.Input
