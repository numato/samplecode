//This C# demo code demonstrates how to use the 32 Channel USB Relay module and demonstrates its
...
namespace _32ChannelUsbRelayModuleDemo
{
    public partial class Form1 : Form
    {
        ...
        private void relayWriteallButton_Click(object sender, EventArgs e)
        {
            ...
            if (!serialPort1.IsOpen)                                                                              //condition
                serialPort1.Open();
            {
                if (relayWriteallBox.Text.Length == 8)                                                            //condition
                {
                    try                                                                                           //do or act
                    {
                        serialPort1.DiscardInBuffer();                                                            //discard input buffer
        ...
        private void relayReadallButton_Click(object sender, EventArgs e)
        {
                ...
                serialPort1.Open();
            {
                try                                                                                               //do or act
                {
                    ...
                    System.Threading.Thread.Sleep(10);                                                            //system sleep
                    string response = serialPort1.ReadExisting();                                                 //read response string
                    relayReadallStstusBox.Text = response.Substring(15, 8);                                       //extracting string from front end
                    serialPort1.DiscardOutBuffer();                                                               //discard output buffer
                }
                catch                                                                                             //exception
                {
