//This C# demo code demonstrates how to use the 4 Channel USB Powered Relay module and demonstrates its
...
namespace _4ChannelUsbPoweredRelayModuleDemo
{
    public partial class Form1 : Form
    {
        ...
        private void adcButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if (int.Parse(adcNumberBox.Text) < 4)                                                             //condition
                {
                    serialPort1.DiscardInBuffer();                                                                //discard input buffer
        ...
        private void gpiosetButton_Click(object sender, EventArgs e)
        {
                ...
                serialPort1.Open();
            {
                ...
                {
                    if (int.Parse(gpioNumberBox.Text) < 4)                                                    //condition
                    {
