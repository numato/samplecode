//This C# demo code demonstrates how to use the 16 Channel USB Relay module and demonstrates its
...
namespace _16ChannelUsbRelayDemo
{
    public partial class Form1 : Form
    {
        ...
        private void adcButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if (int.Parse(adcNumberBox.Text) < 5)                                                             //condition
                {
                    serialPort1.DiscardInBuffer();                                                                //discard input buffer
        ...
        private void gpiosetButton_Click(object sender, EventArgs e)
        {
                ...
                serialPort1.Open();
            {
                ...
                {
                    if (int.Parse(gpioNumberBox.Text) < 10)                                                   //condition
                    {
        ...
        private void gpioreadButton_Click(object sender, EventArgs e)
        {
                ...
                serialPort1.Open();
            {
                if (gpioNumberReadBox.Text.Length != 0)                                                       //condition
                {
                    ...
                    if (int.Parse(gpioNumberReadBox.Text) < 10)                                               //condition
                    {
                        try
                        {
                            serialPort1.DiscardInBuffer();                                                    //discard input buffer
        ...
        private void relayWriteallButton_Click(object sender, EventArgs e)
        {
            ...
            if (!serialPort1.IsOpen)                                                                              //condition
                serialPort1.Open();
            {
                if (relayWriteallBox.Text.Length == 4)                                                            //condition
                {
                    try                                                                                           //do or act
                    {
                        serialPort1.DiscardInBuffer();                                                            //discard input buffer
