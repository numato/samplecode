   ...
   public static void main(String[] args) {
    ...
    if(args.length > 0){
            ...
            try {               
                ...
                /* USB Relay 32 Module firmware "version" - device ID get & set                      */
                /************************************************************************** 
                ...
                * ***************************************************************************/
                ...
                port.writeString("\r");               
                port.writeString("relay writeall 00000000\r");
                System.out.println("Info: <relay writeall XXXXXXXX> Command sent...");
                Thread.sleep(100);
                /* Flush the Serial port's TX buffer*/
