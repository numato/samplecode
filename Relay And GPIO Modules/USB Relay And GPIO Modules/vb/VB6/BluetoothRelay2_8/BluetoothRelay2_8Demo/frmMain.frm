...
'This demo code demonstrates how to use Relays on a Bluetooth Relay Module
...
Private Sub cmdGetStatus_Click()
    ...
    If MSComm1.PortOpen = True Then
        ...
        If Val(txtRelayNumber2.Text) < 8 Then
                ...
                'Bluetooth devices takes longer to complete commands
                Sleep (200)
