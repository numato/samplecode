    ...
    public partial class Form1 : Form
    {
        ...
        private void relayonButton_Click(object sender, EventArgs e)
        {
                ...
                serialPort1.Open();
            {
                ...
                {
                    serialPort1.DiscardInBuffer();                                                       	 //discard input buffer
                    serialPort1.Write("relay on 0\r");                                                   	 //writing "relay on X" command to serial port
                    System.Threading.Thread.Sleep(10);                                                   	 //system sleep
                    serialPort1.DiscardOutBuffer();                                                          //discard output buffer
                }
                catch                                                                                     	 //exception
        ...
        private void relayoffButton_Click(object sender, EventArgs e)
        {
                ...
                serialPort1.Open();
            {
                ...
                {
                    serialPort1.DiscardInBuffer();                                                           //discard input buffer
                    serialPort1.Write("relay off 0\r");                                                      //writing "relay on X" command to serial port
                    System.Threading.Thread.Sleep(10);                                                       //system sleep
                    serialPort1.DiscardOutBuffer();                                                          //discard output buffer
                }
                catch                                                                                        //exception
        ...
        private void readRelayButton_Click(object sender, EventArgs e)
        {
                ...
                serialPort1.Open();
            {
                ...
                {
                    serialPort1.DiscardInBuffer();                                                        //discard input buffer
                    serialPort1.Write("relay read 0\r");                                                  //writing "relay on X" command to serial port
                    System.Threading.Thread.Sleep(10);                                                    //system sleep
                    string response = serialPort1.ReadExisting();                                         //read response string
