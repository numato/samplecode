Alphanumeric LCD Display Expansion Module demo code
Numato Lab
http://www.numato.com
http://www.numato.cc

This package contains source and other files necessary to build 
Alphanumeric LCD Display Expansion Module demo for the following boards.
...
The Alphanumeric LCD Display Expansion Module used to test this code is available at
http://numato.com/fpga-boards/expansion-modules/alphanumeric-lcd-display-expansion-module.html
...
build for a different device you need to open LCDExpansionModule.xise
in ISE and change the device in project properties and rebuild.

1. Building the project using Xilinx ISE
   Open the project file LCDExpansionModule.xise using ISE. Right 
...
4           Saturn LX16**           P7
5           Saturn LX45**           P7
6           Waxwing Carrier         P6
7           Waxwing Dev Board       P5
8           Neso(IO Expansion on P5)   P12
9           Skoll(IO Expansion on P5)  P12
